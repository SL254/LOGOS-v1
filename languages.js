const TEXTS = {
  ko: {
    ...
    ui: {
      ...
      bgmLabel: "배경음악",
      sfxLabel: "효과음",
      languageChangeNotice: "*게임중에는 언어를 변경할 수 없습니다.",
      playerAName: "소크라테스",
      playerAColor: "⚪️ 백",
      playerBName: "플라톤",
      playerBColor: "⚫️ 흑",
      gamestate.currentPropositionTitle: "현재 명제",
      completeButton: "명제 완성",
      undoButton: "되돌리기",
      endTurnButton: "턴 종료",
      gamestate.truePropositionsTitle: "참 명제 목록",
      eurekaButton: "유레카!",
      ...
      skillTitle: "고유 능력",
      gamestate.thinkingTimeTurnMessage: "의 사유 시간입니다.",
    ...
    modals: {
      ...
      promptInputHint: "*띄어쓰기를 포함해 정확히 입력해야 합니다.",
      puzzleTitle: "레벨 선택",
  ...
  en: {
    ...
    ui: {
      ...
      gamestate.currentPropositionTitle: "Current Proposition",
      completeButton: "Complete",
      undoButton: "Undo",
      endTurnButton: "End Turn",
      gamestate.truePropositionsTitle: "True Propositions",
      eurekaButton: "Eureka!",
      ...
      gamestate.thinkingTimeTurnMessage: "'s Thinking Time.",
    ...
    modals: {
      ...
      promptInputHint: "*Please enter exactly with correct spacing.",
    ...
    cards: [
      ...
      { type: "Predicate", text: "is a capitalist" },
    ...
    axiom_templates: {
      identity: [
        ...
        "Some dog is a dog",
        "Every dog is a dog",
        "Some capitalist is a capitalist",
        "Every capitalist is a capitalist",
      ],
      subject_good_evil: [
