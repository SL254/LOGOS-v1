const TEXTS = {
  ko: {
    ...
    modals: {
      ...
      assumptionModalTitle: "가정 구성",
      assumptionCurrentPropositionTitle: "구성중인 가정",
      assumptionHandTitle: "사용 가능한 카드",
      assumptionUndoButton: "되돌리기",
      assumptionConfirmButton: "가정 확인",
  ...
  en: {
    ...
    modals: {
      ...
      assumptionModalTitle: "Create Assumption",
      assumptionCurrentPropositionTitle: "Assumption in Progress",
      assumptionHandTitle: "Available Cards",
      assumptionUndoButton: "Undo",
      assumptionConfirmButton: "Confirm Assumption",
